...
/***/ function(module, exports, __webpack_require__) {
	...
	self.layout = function (options) {
	  ...
	  var key = graph.edges.map(function (edge) {
	    return edge.source + edge.target;
	  }).sort().toString();
	  if (key === '') {
	    key = 'nodes: ' + graph.nodes.map(function (node) {
	      return node.name;
	    }).sort().toString();
	  }
	
	  var nodePositions = void 0;
	...
	(function () {
	  var LTRTreeLayouter = function () {
	    ...
	    ltrTreeLayouter.prototype.layout = function (nodes, edges, dimensions, entryNode) {
	      var graph = new _ltrTreeGraph2.default(nodes, edges); // Build a simple graph object
	      ...
	      _ranker2.default.forcePrimaryRankPromotions(graph, entryNode); // Force all entry nodes to be first
	      _ranker2.default.forceSecondaryRankPromotions(graph, entryNode); // Force any leafs that are one level deep from specified entry node to not move all the way to the edge
	
	      var nodesSortedByDepth = sortNodesByDepth(graph);
	      sortNodesWithinDepth(nodesSortedByDepth);
	      var nodePositions = positionNodes(nodesSortedByDepth, dimensions);
	      return nodePositions;
	    };
...
/***/ function(module, exports, __webpack_require__) {
	...
	function Graph(nodes, edges) {
	  ...
	  _lodash2.default.each(edges, function (edge) {
	    ...
	    delete _this._entryNodeMap[edge.target];
	  });
	}
...
/***/ }
/******/ ]);
//# sourceMappingURL=f0b7b65ef55bf4c9c0c4.worker.js.map